...
const SplashScreen: React.FC<SplashScreenProps> = ({ onStart, onViewOrders, onBackToHome, recentOrder }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-fresh-gray-light p-8 text-center">
      <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-md">
        <button 
          ...
          className="mb-4 text-sm text-fresh-green-dark font-semibold self-start hover:text-fresh-green transition-colors"
        >
          ← Back to Main Menu
        </button>
